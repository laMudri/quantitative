...
formal presentations make metatheory difficult, due to incompatibilities
...
\begin{mathpar}
  ...
  \begin{matrix*}[l]
    ...
    \mat I_{ij} \coloneqq \langle i \rvert_j
  \end{matrix*}
  \and
  \begin{matrix*}[l]
    * : \mathbf R^{m \times n} \times \mathbf R^{n \times o} \to \mathbf R^{m \times o} \\
    (MN)_{ik} \coloneqq \sum_j M_{ij}N_{jk}
  \end{matrix*}
  \and
  \begin{matrix*}[l]
    ...
    \times (\Idx n \to \Idx n')
    \to \mathbf R^{m \times n} \\
    \left(M_{f \times g}\right)_{i,j} \coloneqq M_{f\,i,g\,j}
  \end{matrix*}
\end{mathpar}
...
% TODO: Could do with a wee table explaining \ni, \sqni, and \vdash.
...
\begin{proof}
  ...
  By inspection, when usage contexts and constraints are ignored, the typing
  rules of \autoref{fig:rules} become those of an intuitionistic
  $\lambda$-calculus.
\end{proof}
...
instantiation in \autoref{sec:pd} when we embed Pfenning and Davies' S4
...
Agda type formers are highlighted \AgdaRecord{blue}, with other constructions
highlighted \AgdaFunction{green}.
...
\href{https://github.com/laMudri/generic-lr/blob/lin/tlla-submission-2021/src/Specific/Syntax/Traversal.agda\#L9}{\AgdaModule{Specific.Syntax.Traversal}}
...
\begin{definition}[\href{https://github.com/laMudri/generic-lr/blob/lin/tlla-submission-2021/src/Specific/Syntax/Traversal.agda\#L60}{\AgdaRecord{Kit}}]\label{def:kit}
...
\begin{definition}[\href{https://github.com/laMudri/generic-lr/blob/lin/tlla-submission-2021/src/Specific/Syntax/Traversal.agda\#L43}{\AgdaRecord{Env}}]\label{def:env}
...
\begin{theorem}[traversal, \href{https://github.com/laMudri/generic-lr/blob/lin/tlla-submission-2021/src/Specific/Syntax/Traversal.agda\#L83}{\AgdaFunction{trav}}]\label{thm:trav}
  \thmtrav
\end{theorem}
...
\href{https://github.com/laMudri/generic-lr/blob/lin/tlla-submission-2021/src/Specific/Syntax/Renaming.agda\#L9}{\AgdaModule{Specific.Syntax.Renaming}}
and
\href{https://github.com/laMudri/generic-lr/blob/lin/tlla-submission-2021/src/Specific/Syntax/Subuse.agda\#L9}{\AgdaModule{Specific.Syntax.Subuse}}.

\begin{definition}[\href{https://github.com/laMudri/generic-lr/blob/lin/tlla-submission-2021/src/Specific/Syntax/Renaming.agda\#L54}{\AgdaFunction{LVar-kit}}]\label{def:lvar-kit}
...
\begin{lemma}[\href{https://github.com/laMudri/generic-lr/blob/lin/tlla-submission-2021/src/Specific/Syntax/Renaming.agda\#L62}{\AgdaFunction{ren-env}}]\label{lem:ren-env}
...
\end{lemma}
\begin{proof}
  The environment has $\rescomment\Psi \coloneqq \rescomment I_{f\times\id}$,
...
\begin{corollary}[renaming, \href{https://github.com/laMudri/generic-lr/blob/lin/tlla-submission-2021/src/Specific/Syntax/Renaming.agda\#L67}{\AgdaFunction{ren}}]\label{cor:ren}
  Given a type-preserving mapping of plain variables
  $f : \Delta \ni A \to \Gamma \ni A$ such that
  $\resctx P \subres \resctx Q\rescomment I_{f\times\id}$,
...
\begin{corollary}[subusaging, \href{https://github.com/laMudri/generic-lr/blob/lin/tlla-submission-2021/src/Specific/Syntax/Subuse.agda\#L50}{\AgdaFunction{subuse}}]\label{cor:subusage}
...
\href{https://github.com/laMudri/generic-lr/blob/lin/tlla-submission-2021/src/Specific/Syntax/Substitution.agda\#L9}{\AgdaModule{Specific.Syntax.Substitution}}.

\begin{definition}[\href{https://github.com/laMudri/generic-lr/blob/lin/tlla-submission-2021/src/Specific/Syntax/Substitution.agda\#L63}{\AgdaFunction{Tm-kit}}]\label{tm-kit}
...
\begin{corollary}[substitution, \href{https://github.com/laMudri/generic-lr/blob/lin/tlla-submission-2021/src/Specific/Syntax/Substitution.agda\#L69}{\AgdaFunction{sub}}]\label{cor:sub}
...
\begin{proof}
  ...
  Let \(
    \rescomment\Psi \coloneqq \left(\begin{array}{c}
                               \rescomment{\mat I}
                               \\ \hline
                               \resctx P
                             \end{array}\right)
...
\begin{lemma}[bind, \href{https://github.com/laMudri/generic-lr/blob/lin/tlla-submission-2021/src/Specific/Syntax/Traversal.agda\#L70}{\AgdaFunction{bindEnv}}]\label{lem:bind}
...
%
  Let \(
    \rescomment{\Psi'} \coloneqq \left(\begin{array}{c|c}
...
\begin{thm:trav}[traversal, \href{https://github.com/laMudri/generic-lr/blob/lin/tlla-submission-2021/src/Specific/Syntax/Traversal.agda\#L83}{\AgdaFunction{trav}}]
  \thmtrav
\end{thm:trav}
\begin{proof}
  ...
  $\resctx P_{i} \coloneqq \resctx Q_{i}\rescomment\Psi$.  This works out
...
%
    %   Let
    %   $\resctx P_{\rescomment M} \coloneqq \resctx Q_{\rescomment M}\rescomment\Psi$
    %   and
    %   $\resctx P_{\rescomment N} \coloneqq \resctx Q_{\rescomment N}\rescomment\Psi$,
...
concentrate on sequent calculus presentations of Linear Logic, using
lists to represent contexts and using explicit splitting along permutations
