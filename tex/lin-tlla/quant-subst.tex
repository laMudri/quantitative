...
If we instantiate $\mathbf R$ to be the $0 \triangleright 1 \triangleleft \omega$ semiring, then we obtain a system that is equivalent to Barber's DILL \cite{Barber1996}.
