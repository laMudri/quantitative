...
\item Guillaume Allais \cite{allais:LIPIcs:2018:10049}: \emph{Typing
    with Leftovers}.
\item Arjen's CPP paper on formalising session type calculi. Uses
  separation logic / bunched implications.
\end{itemize}
...
\begin{definition}[Vector and matrix operations]
  \begin{mathpar}
    \langle i \rvert_j =
    \begin{cases}
      1, & \textrm{if }i = j \\
