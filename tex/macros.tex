...
\newcommand{\rowcat}[2]{\left({#1}\mid{#2}\right)}
%\newcommand{\rowcat}[2]{\left(\begin{array}{c|c}{#1}&{#2}\end{array}\right)}
\newcommand{\colcat}[2]{\left(\begin{array}{c}{#1}\\\hline{#2}\end{array}\right)}
